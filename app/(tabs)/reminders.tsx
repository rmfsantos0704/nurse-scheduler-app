  ...
  if (loading) {
    return (
      <View style={[s.loader, { backgroundColor: bg }]}>
        ...
        <Text style={[s.loaderTxt, { color: colors.textSecondary }]}>
          Loading reminders...
        </Text>
      </View>
    );
...
// ─── Section wrapper ─────────────────────────────────────────────────────────
function Section({
  label, count, countColor, children,
}: {
      ...
      <View style={s.cardBody}>
        ...
        <View style={s.cardTopRow}>
          <View style={[s.typePill, { backgroundColor: getTypeBg(item.type) }]}>
            <Text style={[s.typePillTxt, { color: getTypeColor(item.type) }]}>
              {item.type}
            </Text>
          </View>
